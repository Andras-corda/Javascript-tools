...
**This repository is dedicated to JavaScript scripts, and contains a bit of everything, mostly ideas that have crossed my mind or things I've needed at one time or another.**
...
|  `--seed` | random | Makes output reproducible |
